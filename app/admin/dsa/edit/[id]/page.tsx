    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          returnType: problem.returnType || { cType: 'int', sizeParam: '' },
          javaMetadata: problem.javaMetadata || { functionName: '', parameters: [], returnType: { type: 'int' } },
          pythonMetadata: problem.pythonMetadata || { functionName: '', parameters: [], returnType: { type: 'int' } }
        })
      }
    } catch (error) {
